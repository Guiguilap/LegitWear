...
@media(max-width:639px){
    ...
    .nav-center-open .nav-link-login{display:block}
  }
 ...
 if (method === "instagram") {
  ...
  return (
    ...
    <div className="share-methods">
            <button className="share-method" onClick={() => share("whatsapp")}>
              <span className="share-method-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884M20.52 3.449C18.24 1.245 15.24 0 12.05 0 5.463 0 .102 5.36.099 11.943c0 2.107.549 4.161 1.595 5.972L0 24l6.223-1.632a11.9 11.9 0 005.827 1.485h.005c6.585 0 11.946-5.363 11.949-11.945 0-3.191-1.243-6.19-3.484-8.443"/></svg>
              </span>
              {t("share_whatsapp")}
            </button>
            <button className="share-method" onClick={() => share("instagram")}>
              <span className="share-method-icon">
            ...
            <button className="share-method" onClick={() => share("sms")}>
              <span className="share-method-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.145 2 11.25c0 2.898 1.436 5.483 3.68 7.181V22l3.372-1.85c.928.257 1.912.396 2.948.396 5.523 0 10-4.145 10-9.25S17.523 2 12 2zm1 12h-2v-2h2v2zm0-4h-2V6h2v4z"/></svg>
              </span>
              {t("share_sms")}
            </button>
            <button className="share-method" onClick={() => share("tiktok")}>
              <span className="share-method-icon">
