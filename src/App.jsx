...
.pricing-grid{display:grid;grid-template-columns:1fr;gap:14px;padding-top:14px}
 ...
 .pricing-badge{position:absolute;top:-14px;left:50%;transform:translateX(-50%);white-space:nowrap;font-size:9px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;padding:3px 10px;border-radius:20px;font-family:'Space Grotesk',sans-serif}
